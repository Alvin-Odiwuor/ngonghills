...
@can('access_products')
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('products.*') || request()->routeIs('product-categories.*') || request()->routeIs('ingredients.*') || request()->routeIs('recipes.*') || request()->routeIs('recipe-ingredients.*') || request()->routeIs('production-runs.*') || request()->routeIs('production-run-ingredients.*') || request()->routeIs('ingredient-stock-adjustments.*') || request()->routeIs('outlets.*') || request()->routeIs('outlet-products.*') ? 'c-show' : '' }}">
    ...
    <ul class="c-sidebar-nav-dropdown-items">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('ingredients.*') ? 'c-active' : '' }}" href="{{ route('ingredients.index') }}">
                <i class="c-sidebar-nav-icon bi bi-box-seam" style="line-height: 1;"></i> Ingredients
            </a>
        </li>
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('recipes.*') ? 'c-active' : '' }}" href="{{ route('recipes.index') }}">
                <i class="c-sidebar-nav-icon bi bi-journal-richtext" style="line-height: 1;"></i> Recipes
            </a>
        </li>
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('recipe-ingredients.*') ? 'c-active' : '' }}" href="{{ route('recipe-ingredients.index') }}">
                <i class="c-sidebar-nav-icon bi bi-list-check" style="line-height: 1;"></i> Recipe Ingredients
            </a>
        </li>
        <li class="c-sidebar-nav-item">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('outlets.*') ? 'c-active' : '' }}" href="{{ route('outlets.index') }}">
                <i class="c-sidebar-nav-icon bi bi-shop" style="line-height: 1;"></i> Outlets
            </a>
        </li>
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('outlet-products.*') ? 'c-active' : '' }}" href="{{ route('outlet-products.index') }}">
                <i class="c-sidebar-nav-icon bi bi-tags" style="line-height: 1;"></i> Outlet Products
            </a>
        </li>
        @can('print_barcodes')
           <li class="c-sidebar-nav-item">
...
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('loyalty-accounts.*') || request()->routeIs('point-transactions.*') || request()->routeIs('rewards.*') || request()->routeIs('redemptions.*') ? 'c-show' : '' }}">
    <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
    ...
    <ul class="c-sidebar-nav-dropdown-items">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('rewards.*') ? 'c-active' : '' }}" href="{{ route('rewards.index') }}">
                <i class="c-sidebar-nav-icon bi bi-gift" style="line-height: 1;"></i> Rewards
            </a>
        </li>
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('redemptions.*') ? 'c-active' : '' }}" href="{{ route('redemptions.index') }}">
                <i class="c-sidebar-nav-icon bi bi-ticket-perforated" style="line-height: 1;"></i> Redemptions
            </a>
        </li>
    </ul>
</li>
